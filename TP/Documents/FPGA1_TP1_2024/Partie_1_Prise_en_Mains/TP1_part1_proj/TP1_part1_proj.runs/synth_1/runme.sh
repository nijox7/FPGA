...
HD_PWD='C:/FPGA/FPGA1_TP1_2024/Partie_1_Prise_en_Mains/TP1_part1_proj/TP1_part1_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TB_impulse_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TB_impulse_count.tcl
