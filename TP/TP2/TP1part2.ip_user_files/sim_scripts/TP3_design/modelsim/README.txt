...
#
# Generated by export_simulation on Mon Feb 23 17:08:20 +0100 2026
#
################################################################################
...
'-reset_run' switch to the './TP3_design.sh' script.

./TP3_design.sh -reset_run
...
./TP3_design.sh -noclean_files

For more information on the script, please type './TP3_design.sh -help'.
